"""
The dbpedia_spotlight_component conducts named entity disambiguation on the user's question
by calling the DBpedia Spotlight API and saving the response to Quanary's triplestore
"""
