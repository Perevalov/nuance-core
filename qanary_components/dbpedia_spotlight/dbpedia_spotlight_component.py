"""
The dbpedia_spotlight_component executes the query generated by the sparql_builder component
on DBpedia and saves the response to Quanary's triplestore
"""
